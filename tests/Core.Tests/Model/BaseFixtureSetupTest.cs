...
namespace AutoFixture.Extensions.Tests
{
    ...
    public class BaseFixtureSetupTest
    {
        ...
        //    // One way to inject
        //    fixtureParent.Inject(fixture, new SimpleChild());
        //    newFixture = fixtureParent.Dependencies.Fixture;
        //    Assert.Same(oldFixture, newFixture);

        //    // Another way to inject
        //    fixture.Inject(fixtureParent, new SimpleChild());
        //    newFixture = fixtureParent.Dependencies.Fixture;
        //    Assert.Same(oldFixture, newFixture);
        //}
        ...
        //    fixtureParent.Invoking(_ => _.Inject(null!, new SimpleChild())).Should().Throw<ArgumentNullException>();
        //}
    }
}
